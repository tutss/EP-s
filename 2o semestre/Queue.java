...
public class Queue<Item> implements Iterable<Item> {
    ...
    /**
    * Merge the given queue, and shuffles it
    *
    * @return the shuffled queue, using the mergesort method
    */
    ...
    /**
    * Divide and conquer method for merging a linked list, while
    * shuffling. Shuffling uses a random variable for choosing
    * which part of the list to choose.
    * @return Node item
    * @param Node
    */
   ...
   /**
    ...
    public Node middle(Node n) {
      ...
      Node setN = n;
      Node pathN = n.next;
      // Moves the pointer two-by-two and the other, one-by-one
      while (pathN != null) {
        pathN = pathN.next;
        if (pathN != null) {
          setN = setN.next;
    ...
    */
    ...
    /**
    * Shuffles the queue uniformly
    *
    * @return the shuffled queue
    */
    public void shuffle() {
      // The shuffling method uses the first 
